    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{ route('store.check-cancelled') }}" class="forms-sample" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-12">
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <select class="form-control select @error('check_id') is-invalid @enderror" name="check_id[]" id="check_id" onchange="updateFields()">
                                            ...
                                            <option value="{{ $check->id }}" data-cheque_sie="{{ $check->checkbook->cheque_sie }}" data-banque="{{ $check->checkbook->bank->nom }}" data-series="{{ $check->checkbook->series }}">
                                                {{ $check->number }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="text" class="form-control" id="cheque_sie_annule" name="cheque_sie_annule" readonly>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        <label for="series_checkbook_annule" class="form-label">Checkbook Series:</label>
                                        <input type="text" class="form-control" id="series_checkbook_annule" name="series_checkbook_annule" readonly>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        <label for="bank_check_annule" class="form-label">Banque:</label>
                                        <input type="text" class="form-control" id="bank_check_annule" name="bank_check_annule" readonly>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="text" class="form-control" id="refe_check_annule" name="refe_check_annule">
                                    </div>
                                </div>
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        <label for="montant_annule">Monatant:</label>
                                        <input type="text" class="form-control" id="montant_annule" name="montant_annule">
                                    </div>
                                </div>
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
